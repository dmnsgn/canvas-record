...
import './common/esnext.iterator.reduce-cd8a9b74.js';
...
var Pr = function () {
    ...
    return function (t) {
      ...
      var W = !1,
        k = !1,
        x = !1;
      W = typeof window == "object", k = typeof importScripts == "function", x = typeof process == "object" && typeof process.versions == "object" && typeof process.versions.node == "string", !W && !x && !k;
      var y = "";
      function z(r) {
      ...
      m = null, t.arguments && (t.arguments), t.thisProgram && (t.thisProgram), t.quit && (t.quit);
      var X;
      ...
      function I(r, n, e) {
        for (var i = n + e, a = ""; !(n >= i);) {
          ...
          var o = r[n++] & 63;
          if ((f & 240) == 224 ? f = (f & 15) << 12 | c << 6 | o : f = (f & 7) << 18 | c << 12 | o << 6 | r[n++] & 63, f < 65536) a += String.fromCharCode(f);else {
            var s = f - 65536;
      ...
      function pn(r) {
        if (G--, t.monitorRunDependencies && t.monitorRunDependencies(G), G == 0 && (ir)) {
          var n = ir;
          ir = null, n();
        }
      }
      ...
      function hn() {
        return !X && (W || k) && typeof fetch == "function" ? fetch(R, {
      ...
      function gn() {
        ...
        function n(c, o) {
          var s = c.exports;
          t.asm = s, K = t.asm.x, Or(K.buffer), tr = t.asm.B, un(t.asm.y), pn();
        }
        vn();
        function e(c) {
          n(c.instance);
        ...
        function a() {
          return !X && typeof WebAssembly.instantiateStreaming == "function" && !Hr(R) && typeof fetch == "function" ? fetch(R, {
            credentials: "same-origin"
          }).then(function (c) {
      ...
      function En(r, n, e, i, a) {
        ...
        n = S(n), H(r, {
          ...
          readValueFromPointer: function (c) {
            var o;
            if (e === 1) o = _r;else if (e === 2) o = Z;else if (e === 4) o = V;else throw new TypeError("Unknown boolean type size: " + n);
...
`);
        var $ = o ? "destructors" : "null",
          q = ["throwBindingError", "invoker", "fn", "runDestructors", "retType", "classParam"],
          fr = [T, i, a, Gr, n[0], n[1]];
      ...
      function Xn(r, n) {
        ...
        H(r, {
          ...
          toWireType: function (i, a) {
            ...
            var o = f(),
              s = Cr(4 + o + 1);
            if (D[s >> 2] = o, e && c) E(a, s + 4, o + 1);else if (c) for (var v = 0; v < o; ++v) {
...
function Kr(_, t = {}) {
  ...
  return P.configure(lr), {
    ...
    async addFrame(w) {
      ...
      P.encode(A, {
        keyFrame: I
      }), A.close(), sr != null && (er + 1) % sr == 0 && (await P.flush()), er++;
    },
    async flush() {
      return P.flush();
    }
...
export default _e;
export { Rr as createFile, Kr as createWebCodecsEncoderWithModule, Sr as isWebCodecsSupported };
